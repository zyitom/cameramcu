...
namespace camera
{
    ...
    public:
        ...
        //*********** 相机初始化 ******************/
        void Init(bool debug_flag, const std::string &config_path, const std::string &intrinsic_para_file_path, std::chrono::_V2::steady_clock::time_point time_start,bool use_mfs = false);
        //********** 相机工作线程 ******************/
        ...
        bool reset();
        //********** 读相机的原始图像 **************/
        bool ReadImg(cv::Mat &image, uint64_t *p_device_timestamp = nullptr, int64_t *p_host_timestamp = nullptr);
        //********** 对相机调参并实时查看效果 *******/
